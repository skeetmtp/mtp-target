...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
          ...
          <tr> 
            <td class="genBoxStart">
              <table width="100%" border="0" cellspacing="0">
                <tr> 
                  <th colspan="3" class="thHead" nowrap>{BOX_NAME} :: {L_MESSAGE}</th>
                </tr>
              </table>
            </td>
          </tr>
    ...
    <tr> 
      ...
      <td width="100%" class="genBox"> 
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr> 
            <td class="genBoxStart"> 
              <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline" dwcopytype="CopyTableRow">
                <tr> 
                  <td class="row2"><span class="genmed"><b>{L_FROM}:</b></span></td>
                  <td width="100%" class="row2" colspan="2"><span class="genmed">{MESSAGE_FROM}</span></td>
                </tr>
                <tr> 
                  <td class="row2"><span class="genmed"><b>{L_TO}:</b></span></td>
                  <td width="100%" class="row2" colspan="2"><span class="genmed">{MESSAGE_TO}</span></td>
                </tr>
                <tr> 
                  <td class="row2"><span class="genmed"><b>{L_POSTED}:</b></span></td>
                ...
                <tr> 
                  ...
                  <td nowrap class="row2" align="right" style="padding-right: 10px;">{QUOTE_PM_IMG}{EDIT_PM_IMG}</td>
                </tr>
              </table>
            </td>
          </tr>
      ...
      <td width="100%" class="genBox"> 
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr> 
		   ...
		   <table border="0" height="18" cellpadding="5" cellspacing="0">
                      <tr> 
                        <td valign="middle" nowrap>{PROFILE_IMG} {PM_IMG} {EMAIL_IMG} {WWW_IMG} {AIM_IMG} {YIM_IMG} {MSN_IMG} {ICQ_IMG}</td>
                    </tr>
                </table>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <tr> 
            <td class="genBoxStart">
				...
				<table border="0" width="100%" class="forumline" cellspacing="0">
					<tr> 
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr> 
	  <td class="tdReplyImgBottom">{REPLY_PM_IMG}</td>
