...
<?php
	require_oncerequire_once("stat_function.php");
	$base = 0;
	$searchName = "";
	...
	printf("<form method=\"post\" action=\"?page=stat_user_search\" name=\"userSearchForm\">");
	...
	if($searchName=="")
	{
		...
		printf("<a href=\"?page=stat_user_search&p_base=%d\">&lt&lt prev %d</a>\n",$prevBase,$textureDisplayedCount);
		printf("</td>\n");
		printf("<td>\n");
		printf("&nbsp");
		printf("</td>\n");
		printf("<td align=\"right\">\n");
		printf("<a href=\"?page=stat_user_search&p_base=%d\">next %d &gt&gt</a>\n",$nextBase,$textureDisplayedCount);
		printf("</td>\n");
		printf("</tr>\n");
	}
	...
	while($ligne = mysql_fetch_array($resultat))
	{
		$userName = $ligne[1];
		$userId = $ligne[0];
		printf("<b><a href=\"?page=stat_user&p_user_id=%s\">%s</a></b><br/>\n",$userId,$userName);
	}
	printf("</td>\n");
	printf("</tr>\n");
