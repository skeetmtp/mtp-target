...
require_once("stat_map_graph_display.php");
	...
	*/
	...
	$yearToStat = thisYear();
	$link = "<a href=\"?page=stat_day&p_day_to_stat=%s&p_month_to_stat=%s&p_year_to_stat=%s\">%s";
	...
	$link = "<a href=\"?page=stat_month&p_month_to_stat=%s&p_year_to_stat=%s\">%s";
	...
	$result=exec_game_db_requete($requete);
	drawMapUsage($html_fp,$result,1,15,"Server usage",array("", "Server"),"<a href=\"?page=stat_server&p_server_id=%d\">%s</a>");
