        ...
        <tr> 
          <td class="genBoxStart">
            <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
              <tr> 
                <th width="4%" height="25" class="thCornerL" nowrap>&nbsp;</th>
                <th class="thTop" nowrap>&nbsp;{L_FORUM}&nbsp;</th>
                <th class="thTop" nowrap>&nbsp;{L_TOPICS}&nbsp;</th>
                <th class="thTop" nowrap>&nbsp;{L_AUTHOR}&nbsp;</th>
                <th class="thTop" nowrap>&nbsp;{L_REPLIES}&nbsp;</th>
                <th class="thTop" nowrap>&nbsp;{L_VIEWS}&nbsp;</th>
              ...
              <tr> 
                ...
                <td class="row2"><span class="topictitle">{searchresults.NEWEST_POST_IMG}{searchresults.TOPIC_TYPE}<a href="{searchresults.U_VIEW_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span><br />
                ...
                <td class="row2" align="center" valign="middle" nowrap><span class="postdetails">{searchresults.LAST_POST_TIME}<br />
