					...
					<tr> 
						<td class="row1">
							...
							<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
							  ...
							  <tr> 
								<th class="catSides" colspan="3"><b>{TOTAL_REGISTERED_USERS_ONLINE}</b></td>
							  </tr>
							  <!-- BEGIN reg_user_row -->
							  <tr> 
								...
								<td width="40%" class="{reg_user_row.ROW_CLASS}" align="center">&nbsp;<span class="gen"><a href="{reg_user_row.U_FORUM_LOCATION}" class="gen">{reg_user_row.FORUM_LOCATION}</a></span>&nbsp;</td>
							  </tr>
							  <!-- END reg_user_row -->
							  <tr> 
							  ...
							  <tr> 
								<th class="catSides" colspan="3"><b>{TOTAL_GUEST_USERS_ONLINE}</b></td>
							  </tr>
							  ...
							  <tr> 
								...
								<td width="40%" class="{guest_user_row.ROW_CLASS}" align="center">&nbsp;<span class="gen"><a href="{guest_user_row.U_FORUM_LOCATION}" class="gen">{guest_user_row.FORUM_LOCATION}</a></span>&nbsp;</td>
							  </tr>
							  <!-- END guest_user_row -->
							</table>
