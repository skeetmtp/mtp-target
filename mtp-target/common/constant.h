...
#define  MT_NETWORK_UPDATE_FREQUENCE 20.0f
...
#define  MT_NETWORK_MY_UPDATE_FREQUENCE_RATIO 1
...
#define MT_NETWORK_FULL_UPDATE_PERIODE ((uint32)MT_NETWORK_MY_UPDATE_FREQUENCE)  //every 1 sec
