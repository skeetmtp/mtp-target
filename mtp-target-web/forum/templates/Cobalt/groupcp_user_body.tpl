              ...
              <tr>
				<td class="cBarStart" valign="top">
                    ...
                    <tr>                     			
                      ...
                      <td class="cattitle"><span class="cattitle">{L_GROUP_MEMBERSHIP_DETAILS}</span></td>
                    </tr>
                  	</table>						
			  ...
			  <tr>
                <td class="cBoxStart">
                  ...
                  <table width="100%" cellpadding="4" cellspacing="1" border="0">
                    ...
                    <tr> 
                      <td class="row1" width="30%"><span class="genmed"><strong>{L_YOU_BELONG_GROUPS}</strong></span></td>
                        ...
                        <table width="90%" cellspacing="0" cellpadding="0" border="0">
                          <tr>
                            <form method="get" action="{S_USERGROUP_ACTION}">
                              ...
                              <td align="center" width="30%" style="padding-bottom: 7px"> 
                                <input type="submit" value="{L_VIEW_INFORMATION}" class="liteoption" name="submit" />
                                {S_HIDDEN_FIELDS} </td>
                            </form>
                          </tr>
                        </table>
                    ...
                    <tr> 
                      <td class="row1" width="30%"><span class="genmed"><strong>{L_PENDING_GROUPS}</strong></span></td>
                      <td class="row2" align="right" width="70%"> 
                        <table width="90%" cellspacing="0" cellpadding="0" border="0">
                          <tr>
                            <form method="get" action="{S_USERGROUP_ACTION}">
                              ...
                              <td align="center" width="30%" style="padding-bottom: 7px"> 
                                <input type="submit" value="{L_VIEW_INFORMATION}" class="liteoption" name="submit2" />
                                {S_HIDDEN_FIELDS} </td>
                            </form>
                          </tr>
                        </table>
                  ...
                  <table width="100%" border="0">
                    <tr>
						<td>
							...
							<table width="100%" cellpadding="4" cellspacing="1" border="0">				
								<tr> 
								  <td class="row1"><span class="genmed"><strong>{L_SELECT_A_GROUP}</strong></span></td>
								</tr>
							</table>
