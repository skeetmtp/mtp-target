			              ...
			              <tr>
							<td class="cBarStart" valign="top">
			                    ...
			                    <tr>                     			
			                      ...
			                      <td class="cattitle" align="center" width="100%"><span class="cattitle">{L_TOPIC_REVIEW}</span></td>
			                    </tr>
			                  	</table>						
			          ...
			          <td width="100%" class="cbox"> 
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<iframe width="100%" height="300" src="{U_REVIEW_TOPIC}" class="default" frameborder="0">
															...
															<tr> 
															  <td class="viewTopicBoxStart">
																  ...
																  <table border="0" width="100%"> 
																	<tr>
																		<td width="125" align="left" valign="top" class="{postrow.ROW_CLASS}"><span class="name"><a name="{postrow.U_POST_ID}"></a><b>{postrow.POSTER_NAME}</b></span></td>
																	...
																	<tr> 
																		<td colspan="2" height="1" class="spaceRow"><img src="templates/Cobalt/images/spacer.gif" alt="" width="1" height="1" /></td>
																	</tr>				 
																</table>
							...
							<!-- END postrow -->
							  ...
							  <tr> 
								...
								<td width="100%" class="viewTopicBox">
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
										<tr>
											<td class="viewTopicBoxStart" align="right">
												<table border="0"><tr><td><span class="gensmall">{S_TIMEZONE}</span></td></tr></table>
											</td>
										</tr>
									</table>
