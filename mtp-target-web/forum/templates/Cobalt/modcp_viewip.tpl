        ...
        <tr> 
          <td class="ErrorConfirmBoxStart">		  
			...
			<table width="100%" cellpadding="3" cellspacing="1" border="0">
			  <tr> 
				<th height="22" class="thHead">{L_IP_INFO}</th>
			  </tr>
			</table>		  
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr> 
          <td class="ErrorConfirmBoxStart">	  
			...
			<table width="100%" cellpadding="3" cellspacing="1" border="0">
			  <tr> 
				<th class="thHead" height="28">{L_THIS_POST_IP}</th>
			  </tr>
			  <tr> 
				<td class="row1"> 
			  ...
			  <tr> 
				<th class="thHead" height="28">{L_OTHER_USERS}</th>
			  </tr>
			  <!-- BEGIN userrow -->
			  <tr> 
			  ...
			  <!-- END userrow -->
			  <tr> 
				<th class="thHead" height="28">{L_OTHER_IPS}</th>
			  </tr>
			  <!-- BEGIN iprow -->
			  <tr> 
