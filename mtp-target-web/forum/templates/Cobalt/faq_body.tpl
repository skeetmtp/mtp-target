              ...
              <tr>
				<td class="cBarStart" valign="top">
                    ...
                    <tr>                     			
                      ...
                      <td class="cattitle"><span class="cattitle">{L_FAQ_TITLE}</span></td>
                    </tr>
                  	</table>						
						...
						<table border="0">
						  <tr>
							<td>
							  ...
							  <!-- BEGIN faq_row_link -->
							  <span class="gen"><a href="{faq_block_link.faq_row_link.U_FAQ_LINK}" class="faqlink">{faq_block_link.faq_row_link.FAQ_LINK}</a></span><br />
							  <!-- END faq_row_link -->
							  <br />
							  <!-- END faq_block_link -->
					  		</td>
        ...
        <tr>
          ...
          <td width="100%" class="cbox">
						...
						<table width="100%" cellspacing="0" cellpadding="3" border="0" align="center">
							<tr> 
								<td class="catHead" height="28" align="center"><span style="font-weight: bold">{faq_block.BLOCK_TITLE}</span></td>
							</tr>
						</table>
						...
						<td class="cBoxStart">				
							...
							<!-- BEGIN faq_row -->
								...
								<table width="100%" cellspacing="1" cellpadding="3" border="0" align="center">	
									<tr> 
										<td class="{faq_block.faq_row.ROW_CLASS}" align="left" valign="top"><span class="postbody"><a name="{faq_block.faq_row.U_FAQ_ID}"></a><b>{faq_block.faq_row.FAQ_QUESTION}</b></span><br /><span class="postbody">{faq_block.faq_row.FAQ_ANSWER}<br /><a class="faqlink" href="#Top">{L_BACK_TO_TOP}</a></span></td>
									</tr>
									<tr>
...
<table width="100%" cellspacing="2" border="0" align="center">
	<tr>
		<td align="right" valign="middle" nowrap><br /><br />{JUMPBOX}</td> 
	</tr>
</table>
