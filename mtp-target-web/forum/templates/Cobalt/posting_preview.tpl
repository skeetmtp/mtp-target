	...
	<tr> 
		...
		<td width="100%" class="genBox"> 
			  ...
			  <table border="0" cellspacing="0" cellpadding="5" width="100%">
				<tr> 
				  <td class="genBoxStart" style="padding-bottom: 10px">
				  
				  <img src="templates/Cobalt/images/icon_minipost.gif" alt="{L_POST}" /><span class="postdetails">{L_POSTED}: {POST_DATE}     {L_POST_SUBJECT}: {POST_SUBJECT}</span><hr color="#FFFFFF">
