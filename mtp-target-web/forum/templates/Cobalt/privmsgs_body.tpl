...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
          ...
          <tr> 
            <td class="privmsgsBoxStart">
              <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
                <tr> 
                  <th width="5%" height="25" class="thCornerL" nowrap>&nbsp;{L_FLAG}&nbsp;</th>
                ...
                <!-- BEGIN listrow -->
                <tr> 
                  <td class="{listrow.ROW_CLASS}" width="5%" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="23" height="23" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" class="img_topicstatus" /></td>
                  ...
                  <td width="5%" align="center" valign="middle" class="{listrow.ROW_CLASS}"><span class="postdetails"> 
                    <input type="checkbox" class="checkbox" name="mark[]2" value="{listrow.S_MARK_ID}" />
                    </span></td>
                </tr>
                <!-- END listrow -->
                <!-- BEGIN switch_no_messages -->
                <tr> 
                  <td class="row1" colspan="5" align="center" valign="middle"><span class="gen"><p>{L_NO_MESSAGES}</p></span></td>
                </tr>
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
	<tr>
	  <td align="left" valign="middle" class="tdNewImgBottom""><span class="nav">{POST_PM_IMG}</span></td>
